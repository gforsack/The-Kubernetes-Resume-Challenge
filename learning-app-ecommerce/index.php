...
<html lang="en">
    <head>
        ...
        <link href="css/<?php echo $_ENV['FEATURE_DARK_MODE'] === 'true' ? 'bootstrap.min.dark.css' : 'bootstrap.min.css'; ?>" rel="stylesheet">
        <!-- Icon CSS-->
        ...
        <link href="css/<?php echo $_ENV['FEATURE_DARK_MODE'] === 'true' ? 'style-dark.css' : 'style.css'; ?>" rel="stylesheet">
        ...
        <section class="best_business_area row">
            ...
            <div class="row it_works">
              <?php
                        ...
                        // $link = mysqli_connect('mariadb-container', 'ecomuser', 'ecompassword', 'ecomdb');
